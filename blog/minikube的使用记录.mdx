...
<LinkCard title='kubectl cheat sheet' link='https://spacelift.io/blog/kubernetes-cheat-sheet' />

minikube教程中提供了一个`kubernetes 101`教程，里面完整介绍了一个项目用到的kubectl命令：

<LinkCard title='Kubernetes 101' link='https://minikube.sigs.k8s.io/docs/tutorials/kubernetes_101/' />
...
<LinkCard title='kubernetes 官方文档' link='https://kubernetes.io/zh-cn/docs/concepts' />
